...
function isBinSymmetry(integer) {
    ...
    if(binary === 1){
    	$('#binary').html("0001" + "<br> <span id='symetrical'>this binary is symetrical!</span>");
    }
    if(binary === reversedBinary && binary.length !== 1){
        $('#binary').html(binary + "<br> <span id='symetrical'>this binary is symetrical!</span>");
    }else{
    	$('#binary').html(binary + "<br> <span id='symetrical'>this binary is not symetrical</span>");
    }
